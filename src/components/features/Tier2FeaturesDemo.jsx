...
// ════════════════════════════════════════
const FEATURES = [
  { id: "companion", label: "Live Companion", icon: "📍", desc: "Context-aware trip suggestions based on where the traveler is and what is changing around them." },
  { id: "fitness", label: "Fitness Pacing", icon: "❤️", desc: "Adjust the trip rhythm around energy, walking tolerance, and real-world fatigue." },
  { id: "negotiator", label: "AI Negotiator", icon: "🤝", desc: "Compare booking paths and explain the tradeoff instead of dumping prices in a list." },
];

export default function Tier2FeaturesDemo({ initialFeature = "companion", embedded = false }) {
        ...
        {embedded && (
          <div style={{ marginBottom: 22 }}>
            <div style={{
              ...
              <div>
                <p style={{ fontSize: 11, fontWeight: 700, color: "#1A6DAD", textTransform: "uppercase", letterSpacing: 1.2, marginBottom: 4 }}>Tier 2 features</p>
                <p style={{ fontSize: 14, color: "#5C5142", maxWidth: 620 }}>{activeFeature.desc}</p>
              </div>
              <div style={{ background: "#F3EEFF", color: "#7C3AED", border: "1px solid #DDD6FE", borderRadius: 999, padding: "6px 12px", fontSize: 11, fontWeight: 700, letterSpacing: 0.5 }}>PREMIUM-LEANING</div>
            </div>
